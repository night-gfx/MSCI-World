...
function renderTools(){
  ...
  if($("showZeroPhase").checked){const fullSmooth=zeroPhaseSmoother(dailyFull,+$("smoothWindow").value||21),smooth=fullSmooth.slice(dailyStart);traces.push(...splitTrend(dailyX,smooth,"Zero-Phase Smoother · Look-ahead"));}
