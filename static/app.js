...
function alignToolRangeCard(hasIntraday){
  ...
  const divider=size.l+.845*size.w;card.style.right=`${Math.max(12,graph.clientWidth-divider)}px`;
}
...
function renderTools(){
  ...
  if(hasIntraday){layout.shapes.push({name:"intraday-background",type:"rect",xref:"paper",yref:"paper",x0:.85,x1:1,y0:0,y1:1,fillcolor:"rgba(100,116,139,.11)",line:{width:0},layer:"below"});layout.shapes.push({type:"line",xref:"paper",yref:"paper",x0:.845,x1:.845,y0:0,y1:1,line:{color:"rgba(100,116,139,.38)",width:1,dash:"dot"},layer:"above"});layout.annotations.push({xref:"paper",yref:"paper",x:.415,y:1.035,text:"<b>Daily Historical</b>",showarrow:false,xanchor:"center",yanchor:"bottom",font:{family:"Arial, sans-serif",size:11,color:"#475569"}},{xref:"paper",yref:"paper",x:.93,y:1.035,text:"<b>Intraday</b>",showarrow:false,xanchor:"center",yanchor:"bottom",font:{family:"Arial, sans-serif",size:11,color:"#475569"}});}
