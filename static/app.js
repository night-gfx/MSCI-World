...
function renderTools(){
  ...
  if($("showWhittaker").checked){const fullSmooth=whittakerEilers(dailyFull,+$("smoothLambda").value||1000),smooth=fullSmooth.slice(dailyStart);traces.push(...splitTrend(dailyX,smooth,"Whittaker–Eilers-Smoother · Look-ahead",visibleDailyY));}
